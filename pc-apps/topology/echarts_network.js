...
define('echarts/chart/graph', ['require', '../echarts', 'zrender/core/util', './graph/GraphSeries', './graph/GraphView', './graph/roamAction', './graph/categoryFilter', '../visual/symbol', './graph/categoryVisual', './graph/edgeVisual', './graph/simpleLayout', './graph/circularLayout', './graph/forceLayout', './graph/createView'], function (require) {
...
define('echarts/chart/graph/GraphView', ['require', '../helper/SymbolDraw', '../helper/LineDraw', '../../component/helper/RoamController', '../../util/graphic', './adjustEdge', 'zrender/core/util', '../../echarts'], function (require) {
...
define('echarts/chart/graph/GraphSeries', ['require', '../../data/List', 'zrender/core/util', '../../util/model', '../../model/Model', '../helper/createGraphFromNodeEdge', '../../echarts'], function (require) {
    'use strict';
...
define('echarts/chart/graph/simpleLayout', ['require', './simpleLayoutHelper', './simpleLayoutEdge'], function (require) {
        ...
        ecModel.eachSeriesByType('graph', function (seriesModel) {
            ...
            if (coordSys && coordSys.type !== 'view') {
                ...
                data.each(coordSys.dimensions, function (x, y, idx) {
                    if (!isNaN(x) && !isNaN(y)) {
                        data.setItemLayout(idx, coordSys.dataToPoint([
                            x,
                            y
                        ]));
                    } else {
...
define('echarts/chart/graph/edgeVisual', ['require'], function (require) {
...
define('echarts/chart/helper/createGraphFromNodeEdge', ['require', '../../data/List', '../../data/Graph', '../../data/helper/linkList', '../../data/helper/completeDimensions', '../../CoordinateSystem', 'zrender/core/util', './createListFromArray'], function (require) {
    var List = require('../../data/List');
...
define('echarts/data/helper/linkList', ['require', 'zrender/core/util'], function (require) {
    var zrUtil = require('zrender/core/util');
    var each = zrUtil.each;
    var DATAS = ' __link_datas';
    var MAIN_DATA = ' __link_mainData';
    // Caution:
...
define('echarts/chart/graph/adjustEdge', ['require', 'zrender/core/curve', 'zrender/core/vector'], function (require) {
...
define('echarts/chart/graph/simpleLayoutEdge', ['require', 'zrender/core/vector'], function (require) {
    var vec2 = require('zrender/core/vector');
...
define('echarts/chart/graph/simpleLayoutHelper', ['require', './simpleLayoutEdge'], function (require) {
    var simpleLayoutEdge = require('./simpleLayoutEdge');
...
define('echarts/chart/graph/circularLayoutHelper', ['require', 'zrender/core/vector'], function (require) {
    var vec2 = require('zrender/core/vector');
    return function (seriesModel) {
        var coordSys = seriesModel.coordinateSystem;
        if (coordSys && coordSys.type !== 'view') {
