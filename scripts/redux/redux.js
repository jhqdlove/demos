        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            function createStore(reducer, initialState, enhancer) {
                ...
                function ensureCanMutateNextListeners() {
                    if (nextListeners === currentListeners) {//三个等号，恒等于
                        nextListeners = currentListeners.slice();//slice返回一个副本
                    }
                }
                 ...
                 */
                function subscribe(listener) {//订阅每次state发生变化时的方法，返回一个函数，用来取消本次订阅的方法
                ...
                function dispatch(action) {
                    if (!(0, _isPlainObject2["default"])(action)) {//逗号运算符会在依次执行每个表达式后返回最后一个表达式的运算结果
                        //plain  objects 指这个对象的没有任何属性是从  __proto__ 继承过来/简单对象,通过 "{}" 或者 "new Object" 创建的/含有零个或多个的key/value对
                    ...
                    try {
                        isDispatching = true;
                        currentState = currentReducer(currentState, action);//执行reducer，生成新的状态
                    } finally {
                        isDispatching = false;
                    }
                ...
                dispatch({ type: ActionTypes.INIT });//初始事件
