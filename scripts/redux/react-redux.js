(function webpackUniversalModuleDefinition(root, factory) {
    ...
    /******/ ([
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var Provider = function (_Component) {//Component Provider
                _inherits(Provider, _Component);

                Provider.prototype.getChildContext = function getChildContext() {//传递给子组件的属性-store，需要先通过 childContextTypes 来指定，不然会产生错误
                    return { store: this.store };//createStore
                };

                function Provider(props, context) {//构造函数
                ...
                Provider.prototype.render = function render() {
                    ...
                    return _react.Children.only(children);//返回 children 中仅有的子级。否则抛出异常
                };
            ...
            Provider.propTypes = {//Provider的prop属性校验
                store: _storeShape2["default"].isRequired,//store的类型：模块2中约束的
                children: _react.PropTypes.element.isRequired
            };
            Provider.childContextTypes = {//递给子组件的属性-store,类型校验
